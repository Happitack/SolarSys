...
export const PLANETS_DATA: PlanetData[] = [
    ...
    { name: 'Venus',   mass: 2.45e-6, a: 0.72, color: 0xD4A017, visualRadius: 0.05, textureFile: 'textures/venus.jpg', axialTilt: 177.4, rotationFactor: -0.1, maxTrailPoints: 6000  },
    { name: 'Earth',   mass: 3.00e-6, a: 1.00, color: 0x0000FF, visualRadius: 0.05, textureFile: 'textures/earth.jpg', axialTilt: 23.44, rotationFactor: 1.0, maxTrailPoints: 8000,
            moons: [
                { 
                    name: 'Moon', 
                    mass: 7.35e-8, 
    ...
    { name: 'Mars',    mass: 3.23e-7, a: 1.52, color: 0xFF4500, visualRadius: 0.04, textureFile: 'textures/mars.jpg', axialTilt: 25.19, rotationFactor: 0.9, maxTrailPoints: 10000   },
    { name: 'Jupiter', mass: 9.55e-4, a: 5.20, color: 0xFFD700, visualRadius: 0.18, textureFile: 'textures/jupiter.jpg', axialTilt: 3.13, rotationFactor: 2.5, maxTrailPoints: 15000   },
    { name: 'Saturn',  mass: 2.86e-4, a: 9.58, color: 0xF4A460, visualRadius: 0.16, textureFile: 'textures/saturn.jpg', axialTilt: 26.73, rotationFactor: 2.3, maxTrailPoints: 18000   },
    { name: 'Uranus',  mass: 4.37e-5, a: 19.20, color: 0xADD8E6, visualRadius: 0.12, textureFile: 'textures/uranus.jpg', axialTilt: 97.77, rotationFactor: 1.5, maxTrailPoints: 20000   },
    { name: 'Neptune', mass: 5.15e-5, a: 30.05, color: 0x00008B, visualRadius: 0.12, textureFile: 'textures/neptune.jpg', axialTilt: 28.32, rotationFactor: 1.4, maxTrailPoints: 25000   },
];
